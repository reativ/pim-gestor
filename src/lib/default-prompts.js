/**
 * Default AI prompts for each marketplace.
 * Shared between the Settings page (frontend) and the API (via copy in api/suggest-description.js).
 * If you update these, also update PLATFORM_PROMPTS in api/suggest-description.js.
 */
